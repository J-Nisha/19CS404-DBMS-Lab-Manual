...
## OUTPUT
<img width="1797" height="775" alt="image" src="https://github.com/user-attachments/assets/cae6af39-8e29-4061-8789-91961b0e9b43" />
...
```
## OUTPUT
<img width="1585" height="796" alt="image" src="https://github.com/user-attachments/assets/942b9610-45de-4a07-858b-45946f1fbc01" />
...
EXCEPTION
    WHEN table_missing THEN
        DBMS_OUTPUT.PUT_LINE('Error: The table "employees" does not exist or you have no access.');
    WHEN NO_DATA_FOUND THEN
        DBMS_OUTPUT.PUT_LINE('No employees found.');
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Unexpected error: ' || SQLERRM);
...
```
## OUTPUT
<img width="1543" height="715" alt="image" src="https://github.com/user-attachments/assets/8d4a3793-2bee-44bc-8161-31ba60897e7c" />
...
```
## OUTPUT
<img width="1805" height="802" alt="image" src="https://github.com/user-attachments/assets/1473d92a-1f42-469e-a074-29028e345efc" />
...
```
## OUTPUT
<img width="1653" height="796" alt="image" src="https://github.com/user-attachments/assets/544f03fc-739d-4b47-b569-2b034b2b90e6" />
